...
<body>
	<table id="tab" class="easyui-datagrid"   
        data-options="fit:true,url:'adminSeeUser_allUser',fitColumns:true,singleSelect:true,toolbar:'#tb'">   
	    <thead>   
	        <tr>   
	            <th data-options="field:'uid',width:100">用户编号</th>
	            <th data-options="field:'uname',width:100">名称</th>
	            <th data-options="field:'upwd',width:100">密码</th>
	            <th data-options="field:'uclass',width:100">班级</th>
	            <th data-options="field:'utel',width:100">电话</th>
	            <th data-options="field:'borrownum',width:100">借书数量</th>
	        </tr>   
	    </thead>   
	</table> 
