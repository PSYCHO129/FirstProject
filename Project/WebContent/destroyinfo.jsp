...
<body>
	<table id="tab" class="easyui-datagrid"   
        data-options="fit:true,url:'destroy_alldestroy',fitColumns:true,singleSelect:true,toolbar:'#tb'">   
	    <thead>   
	        <tr>   
	            <th data-options="field:'did',width:100">编号</th>
	            <th data-options="field:'dname',width:100">名称</th>
	            <th data-options="field:'dnote',width:100">类型</th>
	            <th data-options="field:'dealname',width:100">处理人</th>
	        </tr>   
	    </thead>   
	</table> 
