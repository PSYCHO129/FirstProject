	...
	<div id="cc" class="easyui-layout">
	    ...
	    <div id="left" data-options="region:'west',split:false" style="width:252px;">
	    	...
	    	<div id="aa" class="easyui-accordion" style="width:250px;height:300px;">   
			    <div title="系统用户管理" data-options="selected:true" style="overflow:auto;padding:10px;">   
			        <a href="#" onclick="add('管理员信息','admin.jsp');">管理员管理</a><br><br>   
			    </div>   
			    <div title="读者管理" style="padding:10px;">
			         <a href="#" onclick="add('读者信息','alluser.jsp');">读者信息</a><br>
			         <% 
			    ...
			    <div title="图书管理">   
			         <a href="#" onclick="add('图书信息','bookinfo.jsp');">图书信息</a><br>
			         <a href="#" onclick="add('类别信息','type.jsp');">图书类别</a>    
			    </div>
			    <div title="图书借还管理">   
			         <a href="#" onclick="add('借阅信息','borrowinfo.jsp');">借阅信息</a><br>
			    </div>
			    <div title="还书申请">   
			         <a href="#" onclick="add('还书信息','returninfo.jsp');">还书信息</a><br>
			    </div>
			    <div title="旧书销毁管理">   
			         <a href="#" onclick="add('销毁信息','destroyinfo.jsp');">销毁记录</a>    
			    </div>
			    <div title="推荐信息">   
