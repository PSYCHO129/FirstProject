...
<body>
	<table id="tab" class="easyui-datagrid"   
        data-options="fit:true,url:'recommendbook_allrecommendbook',fitColumns:true,singleSelect:true,toolbar:'#tb'">   
	    <thead>   
	        <tr>   
	            <th data-options="field:'rbid',width:100">编号</th>
	            <th data-options="field:'bname',width:100">名称</th>
	            <th data-options="field:'rbsum',width:100">数量</th>
	        </tr>   
	    </thead>   
	</table> 
