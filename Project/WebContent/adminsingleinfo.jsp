...
<body>
	<table id="tab" class="easyui-datagrid"   
        data-options="onLoadSuccess:onLoadSuccess,url:'admin_querybyname',
			queryParams: {
				'admin.ausername': '${admin}'
			},fit:true,fitColumns:true,singleSelect:true,toolbar:'#tb'">   
	    <thead>   
	        <tr>   
